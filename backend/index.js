// In this example you can find simple way how to forward multiple requests and responses in one Express.js application.
// e.g.:
//
//   [Proxy URLs]                          [Destination/Forwarded URLs]
//
//   http://localhost:3000/website-1/  ->  http://localhost:3000/
//   http://localhost:3000/website-2/  ->  http://localhost:5000/path/
//   http://localhost:3000/website-3/  ->  http://localhost:5500/resource/path/

// Finally we should be able to call the following URLs:
//
//   http://localhost:3000/website-1/
//   http://localhost:3000/website-1/path/to/resource/
//   http://localhost:3000/website-2/
//   http://localhost:3000/website-2/path/to/resource/
//   http://localhost:3000/website-3/
//   http://localhost:3000/website-3/path/to/resource/
//                                  ^^^^^^^^^^^^^^^^^^
//                                  ||||||||||||||||||
//                    this part will be forwarded to the destination URL
 ...
 * @param {*} proxyAgent HTTP aget that is used to make requests (optional)
 */
const createProxy = (expressApp, proxyPath, dstUrl, proxyAgent = null) => {
