// SOURCE: https://dirask.com/snippets/Node-js-Express-js-create-proxy-forward-request-and-response-of-HTTP-protocol-Dl6rGj
...
const createProxy = (expressApp, proxyPath, dstUrl, proxyAgent = null) => {
    ...
    if (parsedUrl.search) {
        throw new Error('Incorrect destination URL (query component is not allowed).');
    }
    if (proxyAgent == null) {
